    ...
    <header className="h-16 border-b border-border bg-background/80 backdrop-blur-md flex items-center justify-between px-6 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-card border border-border">
          ...
          <div
            className={`font-mono font-bold ${scoreColor}`}
          >
            {score}%
          </div>
        </div>
        ...
        <div className="relative">
          ...
          {showProfile && (
            <>
              ...
              <div
                className="absolute right-0 mt-2 w-56 rounded-xl border border-border shadow-2xl z-50 overflow-hidden"
                style={{
                  backgroundColor:
                    "#0f0f1a",
                }}
