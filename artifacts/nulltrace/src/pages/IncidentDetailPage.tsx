...
export default function IncidentDetailPage() {
  ...
  const safeTimeline = Array.isArray(
    timeline
  )
    ? timeline
    : [];
                ...
                0 ? (
                  safeCommands.map(
                    (
                      ...
                      >
                        <span className="text-muted-foreground select-none mr-3 mt-0.5">
                          $
                        </span>
                  ...
                  safeServices.map(
                    (
                      ...
                      <Badge
                        key={svc}
                        variant="outline"
                        className="bg-background/50 py-1.5 px-3"
                      >
                        {svc}
                      </Badge>
                    )
