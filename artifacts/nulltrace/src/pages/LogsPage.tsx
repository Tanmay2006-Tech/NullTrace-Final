    ...
    <MainLayout>
      <div className="flex flex-col h-full gap-4">
        ...
        <div className="flex-1 glass-card rounded-xl border border-border bg-black/90 overflow-hidden flex flex-col font-mono text-sm shadow-2xl">
          ...
          <div
            ref={scrollRef}
            className="flex-1 overflow-y-auto p-3 space-y-0.5 scroll-smooth"
          >
            {filteredLogs.map(
              (log: any) => (
                <div
                ...
                >
                  ...
                  <span
                    className={`w-12 shrink-0 font-bold text-xs mt-0.5 ${
                      LEVEL_COLOR?.[
                        log?.level
                      ] ||
                      "text-gray-400"
                  ...
                  <span
                    className="text-primary/60 shrink-0 w-28 truncate text-xs mt-0.5"
                    title={
                      log?.service ||
                      "unknown"
                    }
